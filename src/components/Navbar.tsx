    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between h-16">
        <a href="#" className="flex items-center gap-2 font-bold text-xl text-primary">
          ...
          <span>J<span className="text-foreground">ohn</span></span>
        </a>
        ...
        <a href="mailto:john@example.com" className="hidden md:inline-flex px-4 py-2 rounded-lg glow-border text-sm font-medium text-primary hover:bg-primary/10 transition-colors">
          Hire Me
        </a>
